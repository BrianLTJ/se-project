...
class AddBookTest(StaticLiveServerTestCase):
    ...
    taglist =["BHpmw","MNIoT","va0crc","9w3pgs","ZnkNH","XXrcB","ZANkuR","1xTD","0Daf","pGyleT","lAD9","s6yAXa","22RC4s","SrZ6Ab","v3Fp9","XtwR3","W87Xd","NYAi0","GrvlN","typM","T96Ol","z1gg","TWqmR5","JrIh","gIfn","RrCU","r4jx"]
    ...
    def test_add_book_with_cate(self):
        # Add book
