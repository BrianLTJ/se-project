...
class Book(models.Model):
    ...
    translator = models.CharField(max_length=200, null=True,default="", blank=True)
    edition = models.CharField(max_length=50, null=True,default="", blank=True)
    pubhouse = models.CharField(max_length=100, null=True,default="", blank=True)
    pubtime = models.CharField(max_length=50, null=True,default="", blank=True)
